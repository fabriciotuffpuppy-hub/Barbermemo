...
// 3. Copy Landing Page (lp/) files to root dist/
...
// 4. Integrate BarberMemo React App build output into root dist/
...
if (fs.existsSync(barbermemoDist)) {
  ...
  for (const entry of barbermemoEntries) {
    if (entry.name === 'index.html') {
      // Rename React SPA index.html to app.html for Vercel rewrites
      fs.copyFileSync(
